...
def error_message_detail(error: Exception, error_detail: sys) -> str:
    """
    Extracts detailed information about the error, including the file name, line number, and error message.
    ...
    # Extract trackback details from error information
    ...
    # Create a formatted error message in string with file name, line number, and actual error
